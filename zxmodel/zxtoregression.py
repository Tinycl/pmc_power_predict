...
DATA = pd.read_csv('zxout.csv')
DATA_MATRIX = DATA[stritems]
print("DATA dimension",DATA_MATRIX.shape)
#print("DATA is \n", DATA_MATRIX.head())
strdvitems = stritems[0:1]
print(strdvitems)
del stritems[0:1]
print(stritems)
IV_MATRIX =   DATA[stritems]
#print("IV \n",IV_MATRIX)
DV_PP0 = DATA[strdvitems[0]]
print("PP0:\n",DV_PP0.head())
IV_train,IV_test,PP0_train,PP0_test = train_test_split(IV_MATRIX,DV_PP0,test_size=0.8,random_state=0)
